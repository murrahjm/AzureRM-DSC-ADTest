...
$DSCRegPrimaryKey = $($DSCRegInfo.PrimaryKey | ConvertTo-SecureString -AsPlainText -Force).ToString()
 
write-host "##vso[task.setvariable variable=DSCRegistrationKey;]$DSCRegPrimaryKey"
